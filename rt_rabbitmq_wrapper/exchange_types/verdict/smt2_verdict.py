...
class SMT2Verdict(AnalysisVerdict):
    ...
    def __repr__(self):
        return f"(timestamp: {self.timestamp}) - smt2 analysis(name: {self.property_name}, spec_build_time: {self.spec_build_time}, analysis_time: {self.analysis_time}, verdict: {self.verdict.name})"
